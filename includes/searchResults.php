...
case "searchTitle":
	...
	while ($row = pg_fetch_array($searchTitleSQLResult)) {
		echo "<tr><td>" . htmlspecialchars($row[0]) . "</td><td>" . htmlspecialchars($row[1]) . " " . htmlspecialchars($row[2]) . "</td><td>" . htmlspecialchars($row[3]) . "</td><td>" . htmlspecialchars($row[4]) . "</td><td>" . htmlspecialchars($row[5]) . " " . htmlspecialchars($row[6]) . "</td></tr>"; 
		}
	} else {
